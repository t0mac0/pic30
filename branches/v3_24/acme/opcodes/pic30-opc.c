...
const char *pic30_page_registers[] = { "DSRPAG", "DSWPAG", "<not-a-pag>", 
                                       "TBLPAG", 0 };
...
const struct pic30_opcode pic30_opcodes[] =
{
   ...
   /***************************************************************************
    * CPBEQ
    ***************************************************************************/   { "cpbeq.b",   CPWBEQ_B,   3, { BASE_REG, REG,  BRANCH_LABEL_SLIT6  },                                                     F_ECORE | F_CANNOT_FOLLOW_REPEAT },
   { "cpbeq.w",   CPWBEQ_W,   3, { BASE_REG, REG, BRANCH_LABEL_SLIT6  },                                                       F_ECORE | F_WORD |
                                               F_CANNOT_FOLLOW_REPEAT },
   { "cpbeq",     CPWBEQ_W,   3, { BASE_REG, REG, BRANCH_LABEL_SLIT6  },                                                       F_ECORE | F_WORD |
                                               F_CANNOT_FOLLOW_REPEAT },
   /***************************************************************************
    * CPBGT
    ***************************************************************************/   { "cpbgt.b",   CPWBGT_B,   3, { BASE_REG, REG,  BRANCH_LABEL_SLIT6  },                                                     F_ECORE | F_CANNOT_FOLLOW_REPEAT },
   { "cpbgt.w",   CPWBGT_W,   3, { BASE_REG, REG, BRANCH_LABEL_SLIT6  },                                                       F_ECORE | F_WORD |
                                               F_CANNOT_FOLLOW_REPEAT },
   { "cpbgt",     CPWBGT_W,   3, { BASE_REG, REG, BRANCH_LABEL_SLIT6  },                                                       F_ECORE | F_WORD |
                                               F_CANNOT_FOLLOW_REPEAT },
   /***************************************************************************
    * CPBLT
    ***************************************************************************/   { "cpblt.b",   CPWBLT_B,   3, { BASE_REG, REG,  BRANCH_LABEL_SLIT6  },                                                     F_ECORE | F_CANNOT_FOLLOW_REPEAT },
   { "cpblt.w",   CPWBLT_W,   3, { BASE_REG, REG, BRANCH_LABEL_SLIT6  },                                                       F_ECORE | F_WORD |
                                               F_CANNOT_FOLLOW_REPEAT },
   { "cpblt",     CPWBLT_W,   3, { BASE_REG, REG, BRANCH_LABEL_SLIT6  },                                                       F_ECORE | F_WORD |
                                               F_CANNOT_FOLLOW_REPEAT },
   /***************************************************************************
    * CPBNEQ
    ***************************************************************************/   { "cpbne.b",   CPWBNE_B,   3, { BASE_REG, REG,  BRANCH_LABEL_SLIT6  },                                                     F_ECORE | F_CANNOT_FOLLOW_REPEAT },
   { "cpbne.w",   CPWBNE_W,   3, { BASE_REG, REG, BRANCH_LABEL_SLIT6  },                                                       F_ECORE | F_WORD |
                                               F_CANNOT_FOLLOW_REPEAT },
   { "cpbne",     CPWBNE_W,   3, { BASE_REG, REG, BRANCH_LABEL_SLIT6  },                                                       F_ECORE | F_WORD |
                                               F_CANNOT_FOLLOW_REPEAT },
   ...
   ****************************************************************************/
   ...
   { "movpagw",   MOVPAG_W,   2, { REG, PAGE_REG}, F_ECORE },
